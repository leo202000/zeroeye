...
def check_encryptly_runs(timeout: int = 600) -> tuple[bool, str]:
    ...
    workspace = Path(r"E:\project\bounty_repos\Kickama-lt\_cache") / "tent-of-trials" / "encryptly-preflight"
...
def generate_logd(
    ...
    home = Path.home()
    workspace = Path(r"E:\project\bounty_repos\Kickama-lt\_cache") / "tent-of-trials" / "logd-workspace"
    safe_dir = workspace / "safe"
